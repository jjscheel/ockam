defmodule Ockam.Hub do
  ...
  alias Ockam.Hub.Service.Stream.Index.Worker, as: StreamIndexService
  ...
  def start(_type, _args) do
    ...
    StreamService.create(
      ...
      stream_options: [
        storage_mod: Ockam.Hub.Service.Stream.Storage.Kafka,
        storage_options: [
    ...
    StreamIndexService.create(
      ...
      storage_mod: Ockam.Hub.Service.Stream.Index.KafkaOffset,
      storage_options: [])
